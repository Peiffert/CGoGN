...
void ShaderSimpleNormal::getLocations()
{
	bind();
...
void ShaderSimpleNormal::sendParams()
{
	bind();
...
void ShaderSimpleNormal::setAmbiant(const Geom::Vec4f& ambiant)
{
	bind();
...
void ShaderSimpleNormal::setDiffuse(const Geom::Vec4f& diffuse)
{
	bind();
...
void ShaderSimpleNormal::setLightPosition(const Geom::Vec3f& lightPos)
{
	bind();
...
void ShaderSimpleNormal::setParams(const Geom::Vec4f& ambiant, const Geom::Vec4f& diffuse, const Geom::Vec3f& lightPos)
{
	m_ambiant = ambiant;
	m_diffuse = diffuse;
	m_lightPos = lightPos;
...
unsigned int ShaderSimpleNormal::setAttributeColor(VBO* vbo)
{
	m_vboColor = vbo;
	if (!m_with_color)
	{
...
void ShaderSimpleNormal::unsetAttributeColor()
{
	m_vboColor = NULL;
	if (m_with_color)
	{
