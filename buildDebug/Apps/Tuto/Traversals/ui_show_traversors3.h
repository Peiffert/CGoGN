/********************************************************************************
** Form generated from reading UI file 'show_traversors3.ui'
**
...
#ifndef UI_SHOW_TRAVERSORS3_H
#define UI_SHOW_TRAVERSORS3_H
...
public:
    ...
    void setupUi(QDockWidget *DockWidget)
    {
        ...
        combo2->setFocusPolicy(Qt::NoFocus);

        verticalLayout->addWidget(combo2);

        combo3 = new QComboBox(dockWidgetContents);
        combo3->setObjectName(QString::fromUtf8("combo3"));
        combo3->setFocusPolicy(Qt::NoFocus);

        verticalLayout->addWidget(combo3);
    ...
    void retranslateUi(QDockWidget *DockWidget)
    {
        ...
        label->setText(QApplication::translate("DockWidget", "Traversor3", 0, QApplication::UnicodeUTF8));
        combo1->clear();
